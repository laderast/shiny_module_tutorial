...
There are two reasons why you'd want to modularize your shiny code.

1. **Don't Repeat Yourself**. 

2. **Managing all of the ids in a global namespace is difficult**. Remember that each ui element needs a unique id. As you add more and more ui elements, it becomes difficult to name and track these. Shiny modules give each module pair their own namespace.
...
Then our two modules are independent of each other.
